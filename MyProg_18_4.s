...
; и сортировки массива слов без знака
				...
				MOV r2,#Collumn				; Число слов в массиве
				MOV r3,#Row	
				BL Copy_Array_Sort
...
; Передать параметры и вызвать подпрограмму копирования массива слов
				...
				MOV r6,r2		; Число элементов в столбце
				MOV r7,r3		; Число элементов в строке
...
; Декрементировать счетчик числа скопированных слов
				SUBS r7,#1 	; Выставить флаги результата «S»
